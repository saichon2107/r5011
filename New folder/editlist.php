    ...
    <body>
        <div class="container ">
            <?php include_once('header.html'); 
                ...
                $id_stu = $_GET['id_ser'];
                $sql = "SELECT  s.id_ser, s.pre_ser, s.fname_ser, s.lname_ser, s.tel_ser, s.email_ser, s.j_ser, d.id_room, d.name_room
                ...
                <div class="row mb-3 mt-3 fs-4">
                    ...
                    <div class="col-6">
                        <input type="text" class="form-control" id="id_ser"
                            name="id_id_ser" readonly placeholder="รหัส" value="<?php echo $id; ?>">
                    </div>
                </div>
                <div class="row mb-3 mt-3 fs-4">
